    ...
    <section id="contact">
      <div className="contact-inner">
        ...
        <div className="cta-group" style={{ justifyContent: 'center' }}>
          ...
          <a href="https://www.linkedin.com/in/albert-casta%C3%B1eto-3b829b197/" target="_blank" rel="noopener noreferrer" className="cta cta-secondary">
        ...
        <div className="social-links">
          ...
          <a className="social-link" href="https://www.linkedin.com/in/albert-casta%C3%B1eto-3b829b197/" target="_blank" rel="noopener noreferrer"><i className='bx bxl-linkedin'></i></a>
        </div>
      </div>
    </section>
  )
